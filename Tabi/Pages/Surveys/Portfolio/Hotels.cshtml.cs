...
namespace Tabi.Pages.Portfolio
{
    public class HotelsModel : PageModel
    {
        ...
        [BindProperty]
        public Entry foodEntry { get; set; } = new Entry();
        public HotelsModel(Tabi.Data.TabiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            else if (s.IndexOf("%20") == -1)
            {
                ...
                foodEntry.city = s.Substring(0, s.IndexOf("!"));
        ...
        private async Task UpdatePlace(string s)
        {
            ...
            PlaceRootObject placeRootObject = await placeRetriever.GetPlace("hotels+in+" + s);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            foreach(Entry e in _context.Entry)
            {
                ...
                {
                    f = false;
                    return Redirect("https://localhost:44319/surveys/portfolio/hotels?id=" + Request.QueryString.Value.Substring(4));
