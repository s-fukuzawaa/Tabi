    ...
    public class SightSeeingModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            foreach (Entry e in _context.Entry)
            {
                ...
                {
                    f = false;
                    return Redirect("https://localhost:44319/surveys/portfolio/sightseeing?id=" + Request.QueryString.Value.Substring(4));
